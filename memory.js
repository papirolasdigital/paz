...
;(function( window ) {
  ...
  Memory.prototype.options = {
    ...
    cards : [
      {
        id : 1,
        img: "img/monsters-01.png"
      },
      {
        id : 2,
        img: "img/monsters-02.png"
      },
      {
        id : 3,
        img: "img/monsters-03.png"
      },
      {
        id : 4,
        img: "img/monsters-04.png"
      },
      {
        id : 5,
        img: "img/monsters-05.png"
      },
      {
        id : 6,
        img: "img/monsters-06.png"
      },
      {
        id : 7,
        img: "img/monsters-07.png"
      },
      {
        id : 8,
        img: "img/monsters-08.png"
      },
      {
        id : 9,
        img: "img/monsters-09.png"
      },
      {
        id : 10,
        img: "img/monsters-10.png"
      },
      {
        id : 11,
        img: "img/monsters-11.png"
      },
      {
        id : 12,
        img: "img/monsters-12.png"
      },
      {
        id : 13,
        img: "img/monsters-13.png"
      },
      {
        id : 14,
        img: "img/monsters-14.png"
      },
      {
        id : 15,
        img: "img/monsters-15.png"
      },
      {
        id : 16,
        img: "img/monsters-16.png"
      }
    ],
  ...
  Memory.prototype._setupGame = function() {
    ...
    this.gameMetaHTML = '<div class="mg__meta--left">\
      ...
      <span class="mg__meta--moves">Intentos: \
      <span id="mg__meta--moves">' + this.numMoves + '</span>\
      </span>\
      </div>\
      <div class="mg__meta--right">\
      <button id="mg__button--restart" class="mg__button">Inicio</button>\
      </div>';
    this.gameMeta.innerHTML = this.gameMetaHTML;
    this.game.appendChild(this.gameMeta);

    this.gameStartScreenHTML = '<h2 class="mg__start-screen--heading">Bienvenido al juego de memoria</h2>\
      <p class="mg__start-screen--text">Voltear las tarjetas y tratar de coincidir con ellas en pares. Emparejar todas las tarjetas para ganar. Trata de completar el juego en el menor número de movimientos posibles!</p>\
      <h3 class="mg__start-screen--sub-heading">Selecione un nivel</h3>\
      ...
      if (!this.classList.contains("flipped")) {
        if (self.card1flipped === false && self.card2flipped === false) {
          ...
          if ( self.card1id == self.card2id ) {
			  ...
			  // Muestra algo indicando que encontro una par igual.... tal vez un LAYER INVISIBLE 
			  // 
			  //
			  // Despliega el layer "correcto"
			  var ficha = String(self.card1id) ;
			  var ContadorFicha = ficha; 
			 // Revisar si son 1 o 2 caracteres... por que hay fichas de 1 a 16  
             var CuantosCaracteres = ContadorFicha.length;
			 if (CuantosCaracteres == 1) { ContadorFicha = "0"+ContadorFicha};	  
			 var DireccionFicha =  "ficha-" + ContadorFicha + ".png";
			 document.getElementById("correcto").style.visibility="visible";
			 // Escribe en el Layer que la respuesta es correcta			  			  
			 document.getElementById("correcto").innerHTML ="<img src='"+ DireccionFicha +"'  alt='ficha' width='500' height='1000' /></br><a href='javascript:cierralayer();'><button id='mg__button--restart' class='mg__button'>Continua</button></a>";
          } else {
  ...
  Memory.prototype._winGame = function() {
    ...
    if (this.options.onGameEnd() === false) {
      this._clearGame();
      this.gameMessages.innerHTML = '<h2 class="mg__onend--heading">¡Felicidades!</h2>\
        <p class="mg__onend--message">Has terminado la ronda en ' + this.numMoves + ' movimientos.</p>\
        <button id="mg__onend--restart" class="mg__button">¿Juegas otra vez?</button>';
